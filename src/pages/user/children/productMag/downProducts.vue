  ...
  export default {
    ...
    searchProBySoMuch(){
     ...
     console.log(this.createTime);
      ...
      this.searchPros(this.proName,this.proCode,this.proModel,this.proBrand,this.minPrice,this.maxPrice,startTime,endTime,this.mode,this.state);
    },

//    根据条件查询商品钩子函数
    searchPros(proName,proCode,proModel,proBrand,minPrice,maxPrice,startTime,endTime,mode,state){
      let reqParams = {
        pageSize:10,
