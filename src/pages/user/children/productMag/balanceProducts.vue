    ...
    <div class="allProducts_wrapper">
      ...
      <div class="allProducts_list">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <template slot-scope="scope">
            <div v-if="true">
              <el-button @click="correct(scope.$index, scope.row)" type="text" size="mini">修改</el-button>
            </div>
          </template>
          </el-table-column>
        </el-table>
  ...
  export default {
    ...
    methods:{
      ...
      searchPros(nums,proName,proCode,proModel,proBrand,minPrice,maxPrice,startTime,endTime,mode,state){
        ...
        this.$axios.post('/AfwindProductcommerce/selectByExampleListStatus',reqParams)
        .then((res) => {
