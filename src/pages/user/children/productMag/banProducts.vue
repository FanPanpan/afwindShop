  ...
  <div class="user_nav">
    ...
    <div class="allProducts_filter">
      ...
      <div class="allProducts_item">
        ...
        <el-button type="reset" round>清空条件</el-button>
    ...
    <div class="allProducts_wrapper">
      <div class="secondLevelFilter">
        ...
        <el-button round>重新提交</el-button>
      </div>
...
//查询按钮
     ...
     console.log(this.createTime);
      ...
      this.searchPros(this.proName,this.proCode,this.proModel,this.proBrand,this.minPrice,this.maxPrice,startTime,endTime);
    },

  
//    根据条件查询商品钩子函数
    searchPros(proName,proCode,proModel,proBrand,minPrice,maxPrice,startTime,endTime){
      let reqParams = {
        pageSize:10,
